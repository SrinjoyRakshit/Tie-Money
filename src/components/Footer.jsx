      ...
      <footer className="bg-black text-gray-400 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
          <div>
              ...
              <p className="mb-4">Tie Money - Income Expense Tracker.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Email: tiemoney2k24@gmail.com</p>
            <p>Phone: +91 85090 57138</p>
          </div>
          </div>
        </div>
        <p className="text-center text-xl pt-8">Copyright © 2024 Tie Money. All Rights Reserved</p>
      </footer>
    )
  }
